...
void Mesh::initialiseSphere(int segments, int rings)
{
}

void Mesh::initialiseCone(float radius, float height, int segments)
{
}

void Mesh::initialiseGrid(int rows, int columns)
{
}
